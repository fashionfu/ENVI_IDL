...
- **构建排除值列表**：
  ...
  **单/多波段分析逻辑详细流程**：
  ...
  flowchart TD
      ...
      SingleSet --> SingleVerify{验证数组访问<br/>excludeValues[0, numCols-1]?}
      ...
      SingleFallback --> SingleParse["解析SIZE结果<br/>numRows = sizeInfo[2]<br/>numCols = sizeInfo[3]"]
      ...
      MultiGetSize --> MultiParse["解析SIZE结果<br/>格式: [type, ndims, dim1, dim2, ...]<br/>numRows = sizeInfo[2]<br/>numCols = sizeInfo[3]"]

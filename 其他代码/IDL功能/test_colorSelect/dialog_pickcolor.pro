...
function dialog_pickcolor, $
    ...
    tlb = widget_base(group_leader=dialog_parent, $
    	title=title, $
        /column, $
        tlb_frame_attr=1, $
        /modal, $
    ...
    controls = widget_base(tlb, /row, /align_center, space=10)
    okB = widget_button(controls, value='确定', uvalue='ok')
    cancelB = widget_button(controls, value='取消', uvalue='cancel')

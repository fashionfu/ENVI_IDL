...
;                color=[255,255,255],font = oFont, align=0.5)
...
for i=0,11 do begin
  filename = filepath(root=sourceRoot()+'\data', 'snow' + strcompress(string(i+1,format='(i2)') +'.png',/remove))
...
self.oContainer->add,[self.oScene]

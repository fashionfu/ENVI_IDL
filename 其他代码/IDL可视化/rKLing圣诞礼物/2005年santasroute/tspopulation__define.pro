...
;-
pro tsPopulation::getAllFitness, allFitness=allFitness
  ;gets the fitness values for the entire population

  population = *self.population
  numInPop = n_elements(population)
  allFitness = fltarr(numInPop)
  ;get the fitness of each individual chromosome.
  for i=0, numInPop-1 do $
    allFitness[i] = population[i]->getFitness()
